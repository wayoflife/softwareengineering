...
\begin{tabular}[h]{|c|c|}
  ...
  Newsfeed & Eine immer aktuelle Liste von Neuigkeiten in Form von Posts oder Nachrichten\\\hline
  Post & Ein von einem User verfasster Beitrag in einem Sozialen Netzwerk beliebiger Form\\\hline
  Account & Benutzerkonto eines Anwenders bei einem Dienstleister (Soziales Netzwerk)\\\hline
\end{tabular}
\end{center}
